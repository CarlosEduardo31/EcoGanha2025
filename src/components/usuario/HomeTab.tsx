                    ...
                    <div key={partner.id} className="bg-gray-50 rounded-lg p-3 min-w-[200px] border border-gray-100 hover:shadow-md transition-shadow">
                      ...
                      {availableOffer && (
                        <>
                          ...
                          // />
                          <div className="w-full h-20 sm:h-24 md:h-28 flex items-center justify-center bg-gray-50 rounded-md border border-gray-200 mb-2 overflow-hidden">
                              <img
                                src={availableOffer.image}
                                alt={availableOffer.title}
                            ...
                            <div className="w-full h-20 sm:h-24 md:h-28 bg-gray-100 rounded-md border border-gray-200 mb-2 flex items-center justify-center">
